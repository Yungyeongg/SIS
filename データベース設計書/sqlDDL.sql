...
create table board (
  ...
  , regist_date TIMESTAMP default CURRENT_TIMESTAMP not null
  , answer SMALLINT default 0 not null
...
create table menu (
  ...
  , file_name TEXT
  , link TEXT
  , arrange INTEGER default 0 not null
...
GO
comment on column menu.file_path is 'イメージファイル:メニューのイメージファイル経路'
GO
comment on column menu.file_name is 'イメージファイル名:メニューのイメージファイルの名前'
GO
