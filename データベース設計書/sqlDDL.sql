...
create table access (
  ...
  , del_flag CHAR(1) default ｎ not null
  , registrar NVARCHAR2(50) not null
  , registration_date TIMESTAMP default CURRENT_TIMESTAMP not null
  , renewer NVARCHAR2(50) not null
  , revision_date TIMESTAMP default CURRENT_TIMESTAMP not null
...
create table board (
  ...
  , registrantion_date TIMESTAMP default CURRENT_TIMESTAMP not null
...
GO
comment on column access.registrar is '登録者:登録者のId'
GO
comment on column access.registration_date is '登録日:登録した日'
GO
comment on column access.renewer is '修正者:修正者のId'
GO
comment on column access.revision_date is '修正日:修正する日'
GO
...
GO
comment on column board.registrantion_date is 'お問い合わせの登録日:お問い合わせの登録日'
GO
...
GO
comment on column menu.registrar is '登録者:メニューを登録した登録者のId'
GO
comment on column menu.registration_date is '登録日:メニューを登録した日'
GO
comment on column menu.renewer is '修正者:メニューを修正した修正者のId'
GO
comment on column menu.revision_date is '修正日:メニューを修正した日'
GO
...
GO
comment on column page.image is 'イメージ:イメージ'
GO
...
GO
comment on column page.registrar is '登録者:登録者のId'
GO
comment on column page.registration_date is '登録日:登録した日'
GO
comment on column page.renewer is '修正者:修正者のId'
GO
comment on column page.revision_date is '修正日:修正した日'
GO
...
GO
comment on column partner.image is 'パートナのイメージ:パスワードのイメージ'
GO
comment on column partner.image_url is 'パートナのURL:パスワードのリンクURL'
GO
comment on column partner.del_flag is '削除有無:削除有無を確認'
GO
comment on column partner.registrar is '登録者:パスワードを登録した登録者のId'
GO
comment on column partner.registration_date is '登録日:パスワードを登録した日'
GO
comment on column partner.renewer is '修正者:パスワードを修正した修正者'
GO
comment on column partner.revision_date is '修正日:パスワードを修正した日'
GO
